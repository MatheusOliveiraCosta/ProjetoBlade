...
public class VenderCarroTela extends JDialog {
    ...
    private com.mycompany.projetoblade.model.Veiculo veiculoEditando; // Veículo sendo editado (null se for novo)
    private JLabel titulo; // Referência ao título
    private JButton btnEnviar; // Referência ao botão
    ...
    public VenderCarroTela(JFrame parent, com.mycompany.projetoblade.service.VeiculoService veiculoService, com.mycompany.projetoblade.service.ClienteService clienteService) {
        this(parent, veiculoService, clienteService, null);
    }
    
    public VenderCarroTela(JFrame parent, com.mycompany.projetoblade.service.VeiculoService veiculoService, com.mycompany.projetoblade.service.ClienteService clienteService, com.mycompany.projetoblade.model.Veiculo veiculoEditando) {
        super(parent, true); // Modal
        this.veiculoEditando = veiculoEditando;
        ...
        // Título "Vender meu Veículo" ou "Editar Veículo"
        titulo = new JLabel(veiculoEditando != null ? "Editar Veículo" : "Vender meu Veículo");
        ...
        // Botão "Enviar para Avaliação" ou "Salvar Alterações" (verde)
        btnEnviar = new JButton(veiculoEditando != null ? "Salvar Alterações" : "Enviar para Avaliação");
        ...
        btnEnviar.addActionListener(e -> {
            ...
            try {
                ...
                com.mycompany.projetoblade.model.Veiculo veiculo;
                ...
                if (veiculoEditando != null) {
                    ...
                    // Mantém o chassi e status originais
                } else {
                    // Modo criação: cria novo veículo
                    veiculo = new com.mycompany.projetoblade.model.Veiculo(modelo, marca, ano, placa, chassi);
                    veiculo.setPreco(preco);
                    // set owner if logged
                    if (com.mycompany.projetoblade.utils.Sessao.getClienteLogado() != null) {
                        veiculo.setDono(com.mycompany.projetoblade.utils.Sessao.getClienteLogado());
                    }
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(
                        this,
                        veiculoEditando != null ? "Veículo atualizado com sucesso!" : "Seu veículo foi cadastrado e está disponível em Ofertas!",
                        "Sucesso",
    ...
    /**
     * Método para exibir a tela de edição de veículo
     */
    public static void editar(JFrame parent, com.mycompany.projetoblade.service.VeiculoService veiculoService, com.mycompany.projetoblade.service.ClienteService clienteService, com.mycompany.projetoblade.model.Veiculo veiculo) {
        SwingUtilities.invokeLater(() -> {
            VenderCarroTela tela = new VenderCarroTela(parent, veiculoService, clienteService, veiculo);
            // Preenche os campos com os dados do veículo
            tela.preencherCampos(veiculo);
            tela.setVisible(true);
        });
    }
     ...
     */
    private void preencherCampos(com.mycompany.projetoblade.model.Veiculo veiculo) {
        ...
        campoPreco.setText(String.format("%.2f", veiculo.getPreco()).replace(".", ","));
        // Quilometragem não está no modelo, então deixamos vazio
    }
}
