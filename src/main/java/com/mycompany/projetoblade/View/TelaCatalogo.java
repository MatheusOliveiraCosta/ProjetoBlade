...
public class TelaCatalogo extends JPanel {
            ...
            if (!Sessao.isLogado()) {
                ...
                itemClientes.addActionListener(evt -> {
                    ...
                    SwingUtilities.invokeLater(() -> {
                        TelaGerenciarClientes tela = new TelaGerenciarClientes(parentFrame, clienteService);
    ...
    private class CardVeiculo extends JPanel {
        ...
        public CardVeiculo(Veiculo veiculo) {
            ...
            // Adiciona botões de editar/excluir apenas para administradores
            if (com.mycompany.projetoblade.utils.Sessao.isLogado()) {
                com.mycompany.projetoblade.model.Usuario usuario = com.mycompany.projetoblade.utils.Sessao.getUsuarioLogado();
                if (usuario instanceof com.mycompany.projetoblade.model.Funcionario) {
                    com.mycompany.projetoblade.model.Funcionario func = (com.mycompany.projetoblade.model.Funcionario) usuario;
        ...
        private void editarVeiculo() {
            // Abre VenderCarroTela em modo edição
            VenderCarroTela.editar(parentFrame, veiculoService, clienteService, veiculo);
            // Atualiza a grid após fechar (usa referência da classe externa)
            TelaCatalogo.this.atualizarGridOfertas();
        }
        
        private void excluirVeiculo() {
            int confirm = JOptionPane.showConfirmDialog(
                CardVeiculo.this,
                "Tem certeza que deseja excluir o veículo " + veiculo.getModelo() + "?",
                "Confirmar Exclusão",
            ...
            if (confirm == JOptionPane.YES_OPTION) {
                try {
                    boolean removido = veiculoService.removerVeiculo(veiculo.getIdVeiculo());
                    if (removido) {
                        ...
                        // Atualiza a grid (usa referência da classe externa)
                        TelaCatalogo.this.atualizarGridOfertas();
                    } else {
                        JOptionPane.showMessageDialog(
                            CardVeiculo.this,
